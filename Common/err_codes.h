...
const int ERR_DIFFER_ROOT_TREE = 130;
const int ERR_DIFFER_ROOT_NODES = 131;
const int ERR_DIFFER_ROOT_WRONG_TYPE = 132;
const int ERR_DIFFER_ROOT_WRONG_VALUE = 133;
